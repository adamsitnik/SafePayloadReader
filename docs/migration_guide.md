...
How to use the new package and what are the benefits of using it on Full .NET Framework.

### Allowlist Serialization Binder

How to use the new binder to be more secure (and consume `TypeName` APIs!).